...
export const SESIONES_DEFAULT = [
  {
    ...
    preguntas: [
      { id: 1, tipo: 'sino',       texto: '¿Aprueba la nueva agenda programática del partido 2025-2026?' },
      { id: 2, tipo: 'candidatos', texto: '¿A cuál candidato apoya para la presidencia del Directorio Nacional?', opciones: ['María López García','Carlos Mendez Restrepo','Sandra Morales Pérez'] },
      { id: 3, tipo: 'sino',       texto: '¿Está de acuerdo con la modificación de estatutos del artículo 12?' },
      { id: 4, tipo: 'candidatos', texto: '¿Qué candidato apoya para la Secretaría General?', opciones: ['Jorge Castillo Ruiz','Ana Fernández Torres'] },
    ],
  },
  {
